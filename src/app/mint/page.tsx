...
// --- 1. BADGE DATA ---
const BADGES_DATA = [
    { id: "early-adopter", title: "Early Adopters", desc: "For the pioneers who helped stress-test the network before mainnet.", icon: "military_tech", colorClass: "bg-linear-to-br from-yellow-600 to-yellow-900", glowClass: "badge-glow-gold", rarity: "Legendary", xp: "1,000", locked: false, badgeTypeId: 1 },
    { id: "faucet-flyer", title: "Faucet Frequent Flyer", desc: "Successfully claimed testnet tokens from the MIDL faucet 5+ times.", icon: "water_drop", colorClass: "bg-linear-to-br from-blue-400 to-blue-700", glowClass: "drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]", rarity: "Common", xp: "50", locked: false, badgeTypeId: 2 },
    { id: "liquidity", title: "Liquidity Lord", desc: "Provided >0.01 BTC liquidity...", icon: "waves", colorClass: "bg-linear-to-br from-purple-600 to-purple-900", rarity: "Epic", xp: 450, locked: false, badgeTypeId: 3 },
    { id: "yield", title: "Yield Harvester", desc: "Staked assets in a MIDL lending...", icon: "agriculture", colorClass: "bg-linear-to-br from-emerald-600 to-emerald-900", rarity: "Rare", xp: 200, locked: false, badgeTypeId: 4 },
    { id: "atomic", title: "Atomic Swapper", desc: "Completed 50+ swaps on MIDL...", icon: "swap_horiz", colorClass: "bg-linear-to-br from-orange-600 to-orange-900", rarity: "Rare", xp: 300, locked: true },
    { id: "rune", title: "Rune Runner", desc: "Minted or transferred a Rune token...", icon: "auto_awesome", colorClass: "bg-linear-to-br from-pink-600 to-rose-900", rarity: "Rare", xp: 350, locked: true },
    { id: "ordinal", title: "Ordinal Curator", desc: "Holds at least 30 Bitcoin Ordinal...", icon: "collections", colorClass: "bg-linear-to-br from-indigo-600 to-indigo-900", rarity: "Rare", xp: 300, locked: true },
    { id: "dao", title: "DAO Architect", desc: "Voted on at least 7 governance...", icon: "gavel", colorClass: "bg-linear-to-br from-teal-600 to-teal-900", rarity: "Uncommon", xp: 150, locked: true },
    { id: "sybil", title: "Social Sybil Slayer", desc: "Linked a verified X (Twitter)...", icon: "fingerprint", colorClass: "bg-linear-to-br from-sky-600 to-sky-900", rarity: "Common", xp: 100, locked: true },
    { id: "scout", title: "Ecosystem Scout", desc: "Held at least 10 different tokens...", icon: "travel_explore", colorClass: "bg-linear-to-br from-cyan-600 to-cyan-900", rarity: "Rare", xp: 400, locked: true },
    { id: "iron", title: "Iron Hands", desc: "Supplied collateral and maintained...", icon: "front_hand", colorClass: "bg-linear-to-br from-red-600 to-red-900", rarity: "Epic", xp: 500, locked: true },
    { id: "dev", title: "Smart Contract Artisan", desc: "Deployed a smart contract on MIDL...", icon: "terminal", colorClass: "bg-linear-to-br from-slate-500 to-slate-800", rarity: "Legendary", xp: 900, locked: true }
];
                    ...
                    >
                        {({ openConnectDialog, openAccountDialog, isConnected, isConnecting }) => (
                            <button
                                ...
                                className="flex items-center gap-3 bg-[#f7951d] hover:bg-[#e68a19] text-black px-4 py-2 rounded-lg font-bold transition-all"
                            >
                                {isConnected ? (
                                    <>
                        ...
                        {filteredBadges.map((badge) => {
                            ...
                            return (
                                <div key={badge.id} className={`glass-card rounded-xl p-6 flex flex-col relative ${badge.locked ? 'opacity-60' : 'hover:border-[#f7951d]/50'}`}>
                                    <div className="absolute top-3 right-3 text-[10px] font-bold uppercase tracking-widest text-slate-500">{badge.locked ? 'Locked' : badge.rarity}</div>
